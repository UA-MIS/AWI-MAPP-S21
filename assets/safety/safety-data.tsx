...
export interface SafetyItemFormat {
    id: number;
    title: string;
    image: string;
    description: string;
...
export const SafetyData = new Array<SafetyItemFormat>(
    {
        id: 1,
        title: "Personal Flotation Devices",
        image: "~/assets/safety/images/PFDTypes.jpg",
        description: "Vessels less than 4.9 meters (16 feet) in length will have aboard a type I, II, III, or V personal flotation device for each person. "
         ...
         + "CAUTION: \n \n" + "Personal flotation devices must be accessible and of the proper size. Those that are torn, rotted, or damaged, lose their approval. \n \n"
    ...
    },
    {
        ...
        image: "~/assets/safety/images/FlameArrestor.jpg",
    ...
    {
        id: 3,
        title: "Emergency Cut-Off Switch",
        image: "~/assets/safety/images/EmergencyCutOffSwitch.jpg",
    ...
    },
    {
        id: 4,
        title: "Ditch Bags",
        image: "~/assets/safety/images/ditchbag.jpg",
    ...
    },
    {
        ...
        image: "~/assets/safety/images/FireExtinguisher1.jpg",
    ...
    },
    {
        id: 7,
        title: "Diver's Flag",
        image: "~/assets/safety/images/DiversFlags.jpg",
        description: "The diver's flag will be at least 300 mm (12 inches) square, colored red with a white 500 mm (2 inches) stripe running diagonally from the top staff corner to the bottom "
        + "fly corner. Boat owners will stay at least 30.5 meters (100 feet) away from the displayed flag.",
        link: "https://www.alea.gov/dps/marine-patrol/boat-equipment-checklist-alabama"
    },
    {
        id: 8,
        title: "Lights and Sound Devices",
        image: "~/assets/safety/images/NavigationLights.jpg",
    ...
    },
    {
        ...
        image: "~/assets/safety/images/USCoastGuardApprovedVisualDistressSignals.jpg",
